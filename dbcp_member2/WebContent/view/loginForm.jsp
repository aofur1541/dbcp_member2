...
<%-- 세션에 같이 있다면 현재 로그인 상태임, 세션에 같이 없는 경우 비로그인 상태이므로 로그인 폼 보여주기 --%>
<%
	//세션 여부 확인하기
...
%>
	<script>
		...
		var $tag='<span class="navbar-text">'+name+' 님 반갑습니다.</span>'+ '&nbsp;&nbsp;'+'<button type="button" id="logout" class="btn btn-primary">'+'로그아웃</button>';
